...
System.register('pushedx/realtime-chat/components/ChatFrame', ['flarum/Component', 'flarum/helpers/icon', 'flarum/components/LoadingIndicator', 'flarum/helpers/avatar'], function (_export, _context) {
    ...
    function ChatMessage(id, user, message, created_at) {
        this.id = id;
        this.user = user;
                ...
                babelHelpers.createClass(ChatFrame, [{
                    ...
                    value: function view(ctrl, args) {
                        ...
                        return m('div', { className: 'chat left container ' + (ctrl.beingShown ? '' : 'hidden') }, [m('div', {
                            ...
                            return m('div', { className: 'message-wrapper', title: o.created_at }, [m('span', { className: 'avatar-wrapper', 'data-name': o.user ? o.user.username() : 'Loading...' }, avatar(o.user, { className: 'avatar', onclick: this.insertReference.bind(this, o.user) })), m('span', { className: 'message', 'data-message': o.message, config: this.parseMessage.bind(this) }), m('div', { className: 'clear' })]);
                        }.bind(this))]), m('input', {
                            type: 'text',
                            id: 'chat-input',
                    ...
                    key: 'addMessage',
                    value: function addMessage(ctrl, id, msg, user, created_at, notify, redraw) {
